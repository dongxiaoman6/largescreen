...
exports.default = (await Promise.resolve().then(function () { return require('vue'); })).defineComponent({
    ...
    methods: {
        drawChart: function () {
            ...
            var chartDom = document.getElementById('mainLeft4');
            // 指定图表的配置项和数据  
            var option = {
...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ ref: ("chartRef"), id: ("mainLeft4") }, { style: ({}) }));
    // @ts-ignore
    (__VLS_ctx.chartRef);
    // @ts-ignore
    [chartRef,];
    ...
    var __VLS_internalComponent = (yield Promise.resolve().then(function () { return require('./WaterPolo4.vue'); })).default;
}
